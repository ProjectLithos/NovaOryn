...
public readonly struct FramebufferConfiguration
{
    ...
    /// <example><code>FramebufferConfiguration configuration = FramebufferConfiguration.Default(32U);</code></example>
    ...
    /// <summary>Creates the default 32-pixel framebuffer-font configuration.</summary>
...
public sealed unsafe class FramebufferConsole : IConsole
{
    ...
    {
        _cursorX = _configuration.Margin;
        if (_cursorY > uint.MaxValue - _lineHeight) return false;
