...
{
    [LibraryImport("__Internal", EntryPoint="NovaOrynX64ReadPort8")] internal static partial byte ReadPort8(ushort port);
    [LibraryImport("__Internal", EntryPoint="NovaOrynX64WritePort8")] [return: MarshalAs(UnmanagedType.I1)] internal static partial bool WritePort8(ushort port, byte value);
